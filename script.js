...
function hasilKerucut() {
	...
	var jari2_kerucut = (document.getElementById("thisJkesrucut").value);
	...
	document.getElementById("lp-kerucut").innerHTML = (3.14 * jari2_kerucut) * (jari2_kerucut + garis_pelukis);
